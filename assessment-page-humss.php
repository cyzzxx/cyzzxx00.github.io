    ...
    <section class="assessment-section">
        <div class="min-width__section">
            <div class="section__headings">
                ...
                <h3 id="assessmentCategory"><i class='bx bxs-right-arrow' style="color: limegreen;"></i>&nbsp;&nbsp;Interest Questions:
                 <?php 
                    include 'connection.php';
                    $sql_interest = "SELECT COUNT(*) as total_interest_questions FROM question_humss_int WHERE qtype = 'interest'";
...
if (isset($_GET['user_id'])) {
    ...
    $sql_interest = "SELECT question_text FROM question_humss_int WHERE qtype = 'interest'";
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (array_sum($user_responses) === 0) {
          ...
          echo "<script>
            ...
            $assigned_courses = [];
            $stmt = $con->prepare("SELECT assigned_course FROM question_humss_int WHERE question_text = ?");
            ...
            header("Location: assessment-page-humss-acad.php?user_id=" . $user_id);
            exit();
        }
    }
}
