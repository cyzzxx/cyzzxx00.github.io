...
if ($filterValue === 'all') {
    ...
    $sql = "SELECT id, question_text, qtype FROM question_stem_int UNION SELECT id, question_text, qtype FROM question_stem_acad";
} else {
...
?>
        ...
        <div class="modal-overlay" id="addModal" style="display: none;">
            <div class="modal-content">
                ...
                <form method="POST" class="add-form-controls" action="add-stem-question.php">
                    ...
                    <?php
                        $courseSql = "SELECT course_name FROM courses WHERE strand = 'STEM'";
                    ...
                    while ($courseRow = mysqli_fetch_assoc($courseResult)) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                                    ...
                                    <td data-cell="Operations" class="td-course-text">' . $question_text . '</td>
                                    <td data-cell="Operations">
                                        ...
                                        <div class="update-modal-overlay" id="updateModal_' . $id . '" style="display: none;">
                                            <div class="update-modal-content">
                                                ...
                                                <form method="POST" class="update-form-controls" action="update-stem-question.php">
...
function toggleDropdown(questionId) {
    ...
    if (dropdown.style.display === "block") {
        ...
        function confirmUpdate(questionId) {
            ...
            window.location.href = 'update-stem-question.php?updateid=' + questionId;
        }
        ...
        function confirmDeletion(questionId) {
            window.location.href = 'delete-stem-question.php?confirmed=1&deleteid=' + questionId;
        }
