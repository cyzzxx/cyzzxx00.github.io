...
<html>
  <head>
    ...
    <title>Forgot Password? - FEAPITSAT</title>
  </head>
        ...
        <div class="card mt-5">
          <div class="card-body">
            ...
            <form method="POST" action="forgot-password.php">
              ...
              <br><a href="1n4i13m9d14a-cjrh.php">Go back</a>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  const submitButton = document.getElementById('submitButton'); // Add ID to your submit button
  ...
  function checkEmail() {
    ...
    if (pattern.test(email)) {
      ...
      emailError.innerHTML = '<i class="text-danger">Please enter a valid email using "@gmail.com".</i>';
      submitButton.disabled = true;
    }
  }
</script>
