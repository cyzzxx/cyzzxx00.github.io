...
if ($filterValue === 'all') {
    ...
    $sql = "SELECT id, question_text, qtype FROM question_humss_int UNION SELECT id, question_text, qtype FROM question_humss_acad";
} else {
...
?>
        ...
        <div class="dashboard-info">
            <span class="dashboard-header">Assessment</span>
        </div>
        ...
        <div class="modal-overlay" id="addModal" style="display: none;">
            <div class="modal-content">
                ...
                <form method="POST" class="add-form-controls" action="add-humss-question.php">
                    ...
                    <?php
                        $courseSql = "SELECT course_name FROM courses WHERE strand = 'HUMSS'";
                                        ...
                                        <td data-cell="Operations">
                                            ...
                                            <div class="update-modal-overlay" id="updateModal_' . $id . '" style="display: none;">
                                                <div class="update-modal-content">
                                                    ...
                                                    <form method="POST" class="update-form-controls" action="update-humss-question.php">
...
function toggleDropdown(questionId) {
    ...
    function confirmUpdate(questionId) {
        ...
        window.location.href = 'update-humss-question.php?updateid=' + questionId;
    }
        ...
        function confirmDeletion(questionId) {
            window.location.href = 'delete-humss-question.php?confirmed=1&deleteid=' + questionId;
        }
