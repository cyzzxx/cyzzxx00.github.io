...
if (isset($_POST['update_submit'])) {
    ...
    $update_query_int = "UPDATE question_stem_int SET question_text = ? WHERE id = ?";
    ...
    $update_query_acad = "UPDATE question_stem_acad SET question_text = ? WHERE id = ?";
    ...
    header("Location: admin-stem-questions.php"); // Redirect back to the page
    exit();
}
?>
