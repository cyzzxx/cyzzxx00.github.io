    ...
    if (isset($_POST['add_question'])) {
        if (isset($_POST['question_text'], $_POST['qtype'], $_POST['assigned_course'])) {
            ...
            if (!empty($question_text)) {
                ...
                if ($qtype === 'academic') {
                    // Insert into question_humss_acad
                    $insertQuery = "INSERT INTO question_humss_acad (id, question_text, qtype, assigned_course, keyword) VALUES ('$id', '$question_text', '$qtype', '$assigned_course', '$keyword')";
                    if (mysqli_query($con, $insertQuery)) {
                        ...
                        $updateQuery = "UPDATE question_humss_acad 
                    ...
                    // Insert into question_humss_int
                    $insertQuery = "INSERT INTO question_humss_int (id, question_text, qtype, assigned_course, keyword) VALUES ('$id', '$question_text', '$qtype', '$assigned_course', '$keyword')";
                    if (!mysqli_query($con, $insertQuery)) {
